        ...
        <div className="row">
          <div className="col-lg-5 text-center text-lg-start wow fadeInUp">
            ...
            <p className="text-5 mb-5">
              I enjoy discussing new ideas, projects, and opportunities. Feel free to reach out!
            </p>
            ...
            <p className="text-4">(+91) 8318306914</p>
            <ul className="social-icons social-icons-lg justify-content-center justify-content-lg-start mt-5">
              <li className="social-icons-twitter">
                <Tooltip text="X" placement="top">
                  <a
                    href="https://x.com/PreritAgrawal08"
                    target="_blank"
              ...
              <li className="social-icons-facebook">
                <Tooltip text="Codeforces" placement="top">
                  <a
              ...
              <li className="social-icons-instagram">
                <Tooltip text="Instagram" placement="top">
                  <a
                    href="https://www.instagram.com/preritagrawal_08/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
